...
const PropertyType = [
  ...
  {label: "Standard Home", value:"Standard Home"},
  {label: "Townhouse", value:"Townhouse"},
  {label: "Storage Unit", value:"Storage Unit"},
  {label: "Pod Container", value:"Pod Container"}
  
  ]
const SquareFoot = [
{label: "0-1000", value:"0-1000"},
{label: "1001-2000", value:"1001-2000"},
{label: "2001-3500", value:"2001-3500"},
{label: "3501+", value:"3501+"}

]

const Distance = [
  {label: "Less than 50 yards", value:"Less than 50 yards"},
  {label: "Greater than 50 yards", value:"Greater than 50 yards"}
  ...
  return (
    ...
    <Container>
      ...
      <ColumnContainer>
          ...
          <Select   placeholder={propertyType} value={propertyType} onChange={handlePropertyTypeChange}>
            <Option value="">Select Property Type</Option>
            <Option value="apartment">                                          Apartment</Option>
            <Option value="condo"><HomeImg src={h2}/>Condominium</Option>
            <Option value="home"> <HomeImg src={h3}/>Standard Home</Option>
            <Option value="townhouse"><HomeImg src={h4}/>Townhouse</Option>
            <Option value="storage"><HomeImg src={h5}/>Storage Unit</Option>
            <Option value="pod"><HomeImg src={h6}/>Pod Container</Option>
            <Option value="other"><MdOutlineOtherHouses/>Other</Option>
          ...
          {propertyType === 'apartment' || propertyType === 'condo' ? (
            <>
              ...
              <Select value={selectedSquareFootage} onChange={handleSquareFootageChange}>
