...
export const pack1 = {
    ...
    imgStart: false,
    img: 'https://relocate-storage.s3.us-east-2.amazonaws.com/relocate-images/LocationsImg/ga.svg',
    alt: 'georgia',
    too: 'georgia',
    dark: true,
    primary: true,
...
export const pack2 = {
    ...
    imgStart: true,
    img: 'https://relocate-storage.s3.us-east-2.amazonaws.com/relocate-images/LocationsImg/il.svg',
    alt: 'illinois',
    too: 'illinois',
    dark: true,
    primary: true,
...
export const geo = {
    ...
    topLine: '',
    headline: 'Georgia',
    description: 'Relocate is a moving company that aims to offer its services in all 50 states of the United States. Currently, we operate in Georgia and Illinois, but we are working towards expanding our reach to the rest of the country. Our goal is to become a nationwide moving service, and to achieve that, we are taking a slow and steady approach. We have a long-term plan to open new locations in different states, and we are committed to offering top-quality services in each of these locations. At Relocate, we understand the importance of providing customers with a stress-free moving experience, and we are dedicated to achieving that goal by expanding our presence in every corner of the country.',
    buttonLabel: 'Discover',
    //bg: packerT,
    //logo: GeoLogo,
