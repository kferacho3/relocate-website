        ...
        <ServiceFormContainer>
          ...
          <ServicesWrapper>
                ...
                <ServicesInput   
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'Moving Service'}
                ...
                <ServicesInput  
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'Packing & Unpacking'}
                    onChange={handleChange('service')} 
                    />
                <ServicesOptContainer>
                <ServicesImgContainer>
               ...
               type="radio"
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'Hourly Labor'}
                    onChange={handleChange('service')}   />
                <ServicesOptContainer>
                <ServicesImgContainer>
                ...
                <ServicesInput 
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'Junk Removal'}
                    onChange={handleChange('service')}  />
                <ServicesOptContainer>
                <ServicesImgContainer>
                ...
                <ServicesInput 
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'VIP Moving Service'}
                    onChange={handleChange('service')}   />
                <ServicesOptContainer>
                <ServicesImgContainer>
            ...
            <ServicesOptWrap>
                <ServicesInput 
                  type="radio"
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'Storage'}
                    onChange={handleChange('service')}  />
                <ServicesOptContainer>
                <ServicesImgContainer>
                ...
                <ServicesInput 
                   type="radio"
                    ...
                    name="service"
                    id='service'
                    checked={values.packers === 'TV Mounting'}
                    onChange={handleChange('service')}  />
                <ServicesOptContainer>
                <ServicesImgContainer>
